...
### Firmware
Firmware is available at [OMOTE ESP32 Firmware](https://github.com/OMOTE-Community/OMOTE-Firmware/) and [OMOTE ESP32 Firmware object-oriented](https://github.com/OMOTE-Community/OMOTE-Firmware-object-oriented). See this [comparison of the firmwares](https://github.com/OMOTE-Community/.github/blob/main/profile/firmware-comparison.md).
